...
@section('title',__('tr.Create Child Category'))
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" style="padding:20px;" action="{{ route('store_ChildCategory') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="col-lg-4 file">@lang('tr.Select  Child Image')</label>
                                    <div class="col-md-8">
