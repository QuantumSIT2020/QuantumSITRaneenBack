...
@section('title',__('tr.Show GroupAttributes'))
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="ar_name" value="{{ $GroupAttributes->ar_name }}" disabled name="ar_name" class="form-control" required="" data-parsley-minlength="2">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="en_name">@lang('tr.English Name')</label>
                                <input type="text" id="en_name" value="{{ $GroupAttributes->en_name }}" disabled name="en_name" class="form-control" required="" data-parsley-minlength="2">
                            </div>
                        </div>
                    </div>
