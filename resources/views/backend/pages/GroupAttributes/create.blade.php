...
@section('title',__('tr.Create GroupAttributes'))
...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <form id="advanced-form" action="{{ route('store_GroupAttributes') }}" method="POST" enctype="multipart/form-data" data-parsley-validate="" novalidate="" autocomplete="off">
                    @csrf
                    {{-- First & Last Name --}}
                    <div class="row">
                        <div class="col-lg-6">
