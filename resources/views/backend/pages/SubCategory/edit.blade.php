...
<div class="m-portlet">
    ...
    <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{ route('update_SubCategory',$subCategory_data->id) }}" method="post" enctype="multipart/form-data" id="selectform">
        @csrf
            ...
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="m-input-icon m-input-icon--right">
                        <input type="text" name="en_name" id="en_name"  value="{{ $subCategory_data->en_name }}" class="form-control m-input">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="m-input-icon m-input-icon--right">
                        <input type="text" name="ar_name" id="ar_name"  value="{{ $subCategory_data->ar_name }}" class="form-control m-input">
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <select name="child_category_id" id="child_category_id" class="form-control" required>
