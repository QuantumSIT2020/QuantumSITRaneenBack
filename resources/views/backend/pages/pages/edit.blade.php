...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <form style="padding:20px;" action="{{ route('update_pages',$page_data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">@lang('tr.en_name')</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="en_name" id="en_name" type="text" value="{{ $page_data->en_name }}" >
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="ar_name" id="ar_name" type="text" value="{{ $page_data->ar_name }}" >
                        </div>
