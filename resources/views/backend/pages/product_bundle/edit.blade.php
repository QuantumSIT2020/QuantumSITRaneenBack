...
@section('title',__('tr.Update Bundle'))
...
@section('content')
    <div class="row">
        <div class="card">
            ...
            <div class="body">
                <form id="example-advanced-form" action="{{ route('update_bundles',$bundle->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @include('backend.components.product_bundle_update.information')

                    @include('backend.components.product_bundle_update.bundle')
                </form>
            </div>
        </div>
    </div>
