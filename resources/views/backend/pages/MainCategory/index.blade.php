...
@section('title',__('tr.Main Categories'))
...
@section('morebtn')
    <div class="col-md-6 col-sm-12 text-right hidden-xs">
        <a href="{{ route('create_MainCategory') }}" class="btn btn-sm btn-info" title=""><i class="fa fa-plus"></i>@lang('tr.Create New MainCategory')</a>
    </div>
@endsection
