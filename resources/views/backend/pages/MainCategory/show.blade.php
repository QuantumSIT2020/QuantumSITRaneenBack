                                    ...
                                    <div class="col-xl-8 offset-xl-2">
                                        <div class="m-form__section m-form__section--first">
                                            <div class="m-form__heading">
                                                <h3 class="m-form__heading-title">@lang('tr.MainCategory Details')</h3>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    ...
                                                    <textarea name="en_desc" id="en_desc" cols="30" rows="10" class="form-control m-input" disabled >
                                                       {{ $MainCategory_data->en_desc }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    ...
                                                    <textarea name="ar_desc" id="ar_desc" cols="30" rows="10" class="form-control m-input" disabled >
                                                       {{ $MainCategory_data->ar_desc }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="{{ URL::to('/') }}/backend/dashboard_images/MainCategory/{{$MainCategory_data->main_image }}" class="img-thumbnail" />
                                                    </div>
                                                </div>
                                            </div>
