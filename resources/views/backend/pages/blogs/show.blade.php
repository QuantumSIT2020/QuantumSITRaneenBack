                                    ...
                                    <div class="col-xl-8 offset-xl-2">
                                        <div class="m-form__section m-form__section--first">
                                            <div class="m-form__heading">
                                                <h3 class="m-form__heading-title">@lang('tr.blog Details')</h3>
                                            </div>

                                            <div class="form-group m-form__group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">*@lang('tr.en_name'):</label>
                                                <div class="col-xl-9 col-lg-9">
                                                    <input type="text" name="en_name" class="form-control m-input"  disabled  value="{{ $blog_data->en_name}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <input type="text" name="ar_name" class="form-control m-input"  disabled  value="{{ $blog_data->ar_name}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <div class="input-group">
                                                        ...
                                                        <img src="{{ URL::to('/') }}/backend/dashboard_images/blogs/{{$blog_data->blog_image }}" class="img-thumbnail" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">*@lang('tr.type'):</label>
                                                <div class="col-xl-9 col-lg-9">
                                                    <input type="text" name="type" class="form-control m-input"  disabled  value="{{ $blog_data->type}}">
                                                </div>
                                            </div>
