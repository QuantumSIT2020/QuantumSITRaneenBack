...
@section('title',__('tr.Create New blog'))
            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{route('blogs')}}" class="btn btn btn-info" title="Themeforest">@lang('tr.Back To List')</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" style="padding:20px;" action="{{ route('store_blogs') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="type">@lang('tr.select type'):</label>
                                    <select name="type" id="type" class="custom-select" required>
                                        <option value="">@lang('tr.Select select type')</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" id="file"   name="blog_image" aria-label="File browser example" onchange="readURL(this);" />
